...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-950 via-slate-950 to-red-900 flex flex-col
    items-center justify-center p-3 gap-6">
      <h1 className="text-6xl sm:text-7xl md:text-8xl font-light bg-gradient-to-r
      from-blue-500 via-rose-500 to-indigo-500 bg-clip-text text-transparent text-center">
        AI Text To Speech
      </h1>
      ...
      to-gray-700/90 backdrop-blur-md border
      border-gray-600 rounded-3xl p-6 shadow-2xl">
        <textarea
          className="w-full h-40 p-4 bg-gray-700/80 border
        ...
        <div className="flex gap-3 mt-4">
          <button
            ...
            from-rose-500 to-purple-500 hover:opacity-80 text-white
            font-semibold rounded-2xl transition disabled:opacity-50
          ...
          {currentAudio && (
            <button
              ...
              to-gray-700 hover:opacity-80 text-white font-semibold rounded-2xl
              border border-neutral-500/30 transition cursor-pointer"
              onClick={stopAudio}
            >
              ⏸️ Stop
            </button>
